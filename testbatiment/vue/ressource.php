					...
					<div class="conteneur">			
							...
							<div class="terrain">
								...
								if(isset($_SESSION['race']) AND  isset($_SESSION['niveau']))
								{
									...
									<form class="formRessource" method="post" action="ressource.php" >
										...
										<input type="image" src="asset/image/eau.png" title="Eau" alt="Eau" value="submit"/>
									...
									if($_SESSION['race'] AND $_SESSION['niveau'] >= $niveauTechnoDecouverte )
									{
										if($_SESSION['race'] == 'abeille')
										{
											...
											<form class="formRessource" method="post" action="ressource.php" >
												...
												<input type="image" src="asset/image/bois.png" title="Bois" alt="Bois" value="submit"/>
											...
											<form class="formRessource" method="post" action="ressource.php" >
												...
												<input type="image"  src="asset/image/argile.png" title="Argile" alt="Argile" value="submit" />
											...
											<form class="formRessource" method="post" action="ressource.php" >
												...
												<input type="image"  src="asset/image/cire.png" title="Cire" alt="Cire" value="submit" />
											...
											<form class="formRessource" method="post" action="ressource.php" >
												...
												<input type="image"  src="asset/image/nourriture_abeille.png" title="Nourriture" alt="Nourriture" value="submit" />
										...
										elseif($_SESSION['race'] == 'termite')
										{
											...
											<a  href="#terre"><img src="asset/image/terre.png" title="Terre" alt="Terre"/></a>
											<a  href="#bois"><img src="asset/image/bois.png" title="Bois" alt="Bois"/></a>
											<a  href="#salive"><img src="asset/image/salive.png" title="Salive" alt="Salive"/></a>
											<a  href="#nourriture"><img src="asset/image/nourritureTermite.png" title="Nourriture" alt="Nourriture"/></a>
										...
										elseif($_SESSION['race'] == 'fourmis')
										{
											...
											<a  href="#terre"><img src="asset/image/terre.png" title="Terre" alt="Terre"/></a>
											<a  href="#feuille"><img src="asset/image/feuille.png" title="Feuille" alt="Feuille"/></a>
											<a  href="#cocon"><img src="asset/image/cocon.png" title="Cocon" alt="Cocon"/></a>
											<a  href="#nourriture"><img src="asset/image/nourritureFourmis.png" title="Nourriture" alt="Nourriture"/></a>
										...
										elseif($_SESSION['race'] == 'arraigne')
										{
											...
											<a  href="#feuille"><img src="asset/image/feuille.png" title="Feuille" alt="Feuille"/></a>
											<a  href="#toxine"><img src="asset/image/Toxine.png" title="toxine" alt="Toxine"/></a>
											<a  href="#argile"><img src="asset/image/argile.png" title="Argile" alt="Argile"/></a>
											<a  href="#nourriture"><img src="asset/image/nourritureArraigne.png" title="Nourriture" alt="Nourriture"/></a>
						...
						if(isset($_POST['typeRessource']) )
						{
								...
								if($_POST['typeRessource'] == 'cire')
								{
									...
									<form id="<?php echo $_POST['typeRessource']; ?>" action="../model/traitementRessource.php" method="post">
										...
										<div class="infoPhoto" >
											...
											<img src="<?php echo 'asset/image/'.$_SESSION['typeRessource'].'.png'; ?>" title="<?php echo $_POST['typeRessource']; ?>" alt="<?php echo $_POST['typeRessource']; ?>" />
