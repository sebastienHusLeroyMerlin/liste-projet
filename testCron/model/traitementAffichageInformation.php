...
*/
			...
			$_SESSION['cire'] = ((1+($technoRecolteRessourceProductionCire/100)) * RESSOURCE_CIRE_BASE) * $_SESSION['ouvriere_cire'] ;
			
			$_SESSION['plaine_bois'] =  ((1+($technoRecolteRessourceProductionBois/100)) * RESSOURCE_BOIS_BASE) * COEF_BOIS_PLAINE * $_SESSION['ouvriere_bois_plaine'] ;
			$_SESSION['foret_bois'] =  ((1+($technoRecolteRessourceProductionBois/100)) * RESSOURCE_BOIS_BASE) * COEF_BOIS_FORET * $_SESSION['ouvriere_bois_foret'];
			$_SESSION['marecage_bois'] =  ((1+($technoRecolteRessourceProductionBois/100)) * RESSOURCE_BOIS_BASE) * COEF_BOIS_MARECAGE * $_SESSION['ouvriere_bois_marecage'];
					
			$_SESSION['plaine_argile'] =  ((1+($technoRecolteRessourceProductionArgile/100)) * RESSOURCE_ARGILE_BASE) * COEF_ARGILE_PLAINE * $_SESSION['ouvriere_argile_plaine'];
			$_SESSION['foret_argile'] =  ((1+($technoRecolteRessourceProductionArgile/100)) * RESSOURCE_ARGILE_BASE) * COEF_ARGILE_FORET * $_SESSION['ouvriere_argile_foret'];
			$_SESSION['marecage_argile'] =  ((1+($technoRecolteRessourceProductionArgile/100)) * RESSOURCE_ARGILE_BASE) * COEF_ARGILE_MARECAGE * $_SESSION['ouvriere_argile_marecage'];
					
			$_SESSION['plaine_eau']=  ((1+($technoRecolteRessourceProductionEau/100)) * COEF_EAU_PLAINE) * COEF_EAU_PLAINE * $_SESSION['ouvriere_eau_plaine'];
			$_SESSION['foret_eau'] =  ((1+($technoRecolteRessourceProductionEau/100)) * COEF_EAU_PLAINE) * COEF_EAU_FORET * $_SESSION['ouvriere_eau_foret'];
			$_SESSION['marecage_eau']=  ((1+($technoRecolteRessourceProductionEau/100)) * COEF_EAU_PLAINE) * COEF_EAU_MARECAGE * $_SESSION['ouvriere_eau_marecage'];
					
			$_SESSION['plaine_nourriture']=  ((1+($technoRecolteRessourceProductionNourriture/100)) * RESSOURCE_NOURRITURE_BASE) * COEF_NOURRITURE_PLAINE * $_SESSION['ouvriere_nourriture_plaine'];
			$_SESSION['foret_nourriture'] =  ((1+($technoRecolteRessourceProductionNourriture/100)) * RESSOURCE_NOURRITURE_BASE) * COEF_NOURRITURE_FORET * $_SESSION['ouvriere_nourriture_foret'];
			$_SESSION['marecage_nourriture'] =  ((1+($technoRecolteRessourceProductionNourriture/100)) * RESSOURCE_NOURRITURE_BASE) * COEF_NOURRITURE_MARECAGE * $_SESSION['ouvriere_nourriture_marecage'];
