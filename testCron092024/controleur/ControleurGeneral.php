...
abstract class ControleurGeneral {
    ...
    public function chargerModele(string $modele){
        ...
        */
        ...
        $instanceModele = new  $objModele();        // l' instance modele represente l'objet créé
    ...
    //    require("../controleur/".$destination."ControleurGeneral.php");
    //
    //}
